 ...
 * @author duvan
 */
@WebServlet(name = "GestionEquipos", urlPatterns = {"/GestionEquipos"})
public class GestionEquipos extends HttpServlet {

    String listar = "Vistas/GuardarEquipos.jsp";
    String add = "Vistas/AgregarEquipos.jsp";
    String volverHome = "./index.jsp";
